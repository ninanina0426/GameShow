...
int STAGE_YUKA[MAP_Y][MAP_X] = {
	...
	{19,19,19,19,19,19,19,19, 19,19,19,19,19, 19,19,19,19,19, 19,19,},
	{19,19,19,19,19,19,19,19, 19,19,19,19,19, 19,19,19,19,19, 19,19,},
	{19,19,19,19,19,19,19,19, 19,19,19,248,249, 250,251,252,253, 19,19,19},
	{19,19,19,19,19,19,19,19, 265,266,267,268,269, 270,271,272,273,274, 275,19},
...
int STAGE_KAGU[MAP_Y][MAP_X] = {
	...
	{19,19,19,19,19,   19,19,19,19,19,     19,19,19,19,19,        19,19,19,19,19,},
	{19,19,19,19,19,   19,19,19,19,19,     19,19,19,19,19,        19,19,19,19,19,},
	{19,19,19,19,19,   19,19,529,530,531,     532,533,534,535,536,    537,538,19,19,19},
	{19,19,19,19,546,   547,548,549,550,551,     552,553,554,555,556,    557,558,19,19,19},
	{19,19,19,565,566,   567,568,569,570,571,     572,573,574,575,576,    577,578,19,19,19},
	{19,19,19,585,586,   587,588,589,590,591,     592,593,594,595,596,    597,598,19,19,19},
	{19,19,19,605,546,   607,608,609,610,611,     612,613,614,615,616,    617,618,19,19,19},
	{19,19,19,625,626,   627,628,629,630,631,     632,633,634,635,636,    637,638,19,19,19},
	{19,19,19,645,646,   647,648,649,650,651,     652,653,654,655,656,    657,658,19,19,19},
	{19,19,19,665,666,   667,668,669,670,671,     672,673,674,675,676,    677,678,19,19,19},
	{19,19,19,19,19,   19,19,19,19,19,      19,19,19,19,19,       19,19,19,19,19,},
	{19,19,19,19,19,   19,19,19,19,19,      19,19,19,19,19,       19,19,19,19,19,},
...
void Stage::Draw(void)
{
	...
	for (int y = 0; y < MAP_Y; y++)
	{
		for (int x = 0; x < MAP_X; x++)
		{
			...
			DrawGraph(x * CHIP_SIZE_X, y * CHIP_SIZE_Y, mChipImage[mMap[y][x]], true);
	...
	for (int y = 0; y < MAP_Y; y++)
	{
		for (int x = 0; x < MAP_X; x++)
		{
			...
			DrawGraph(x * CHIP_SIZE_X , y * CHIP_SIZE_Y , mChipImage[mMapYuka[y][x]], true);
	...
	for (int y = 0; y < MAP_Y; y++)
	{
		for (int x = 0; x < MAP_X; x++)
		{
			...
			DrawGraph(x * CHIP_SIZE_X, y * CHIP_SIZE_Y, mChipImage[mMapKagu[y][x]], true);
